...
$config = array(
	...
	*/
	...
	|
	*/
	'thumbs_base_path' => '../../uploads/thumbnail/',
	...
	*/
	...
	#                          4 / crop= resize and crop;
	 */
	'fixed_image_creation_option'             => ['crop', 'auto', 'crop'], //set the type of the crop
	...
	'relative_path_from_current_pos'          => ['medium/', 'large/'], //relative path of the image folder from the current position on upload folder
	'relative_image_creation_name_to_prepend' => ['', ''], //name to prepend on filename
	'relative_image_creation_name_to_append'  => ['_medium', '_large'], //name to append on filename
	'relative_image_creation_width'           => [300, 800], //width of image (you can leave empty if you set height)
	...
	#                          4 / crop= resize and crop;
	 */
	'relative_image_creation_option'          => ['crop', 'auto'], //set the type of the crop
