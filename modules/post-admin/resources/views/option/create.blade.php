...
<div class="row">
    <div class="col-sm-6">
        ...
        {!! Form::open(['method' => 'post', 'route' => 'admin::option.store']) !!}

        <div class="form-group">
            <label>{{trans('admin::view.name')}} (*)</label>
            <input type="text" name="option_key" value="{{ old('option_key') }}"
        ...
        <div class="form-group">
            ...
            <textarea name="value" id="file_url" 
                      ...
                      placeholder="{{trans('admin::view.value')}}">{{ old('value') }}</textarea>
            {!! errorField('value') !!}
            <br />
        ...
        <div class="form-group">
            ...
            <select name="lang_code" class="form-control">
                ...
                @foreach($langs as $lang)
                    <option value="{{$lang->code}}" {{ $lang->code == old('lang_code') ? 'selected' : '' }}>{{$lang->code}}</option>
                @endforeach
            </select>
        </div>
