...
<div class="row">
    <div class="col-sm-8">
        ...
        {!! Form::open(['method' => 'post', 'route' => 'front::account.update_pass']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <a href="{{ route('front::account.profile') }}" class="btn btn-warning"><i class="fa fa-long-arrow-left"></i> {{ trans('admin::view.back') }}</a>
