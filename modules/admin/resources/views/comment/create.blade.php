...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            {!! Form::text('post_id', old('post_id'), ['class' => 'form-control', 'placeholder' => trans('manage.posts')]) !!}
            {!! error_field('post_id') !!}
        </div>
        
        <div class="form-group">
            <label>{{trans('manage.author')}}</label>
            {!! Form::text('author_id', old('author_id'), ['class' => 'form-control', 'placeholder' => trans('manage.author')]) !!}
        </div>
        
        <div class="form-group">
            <label>{{trans('manage.content')}} (*)</label>
            {!! Form::textarea('content', old('content'), ['class' => 'form-control', 'rows' => 5, 'placeholder' => trans('manage.content')]) !!}
            {!! error_field('content') !!}
        </div>
        ...
        <div class="form-group">
            ...
            {!! Form::select('status', [1 => trans('manage.active'), 0 => trans('manage.disable')], old('status'), ['class' => 'form-control']) !!}
        </div>
